...
export class AuthenticationService {
  ...
  getMainCategory(data) {
    return this.http
      .get(API_URLothers + "maincategories?" + "APIKEY=" + data)
      .pipe(map((res: Response) => res));
  }

  getsubCategory(data, catid) {
    return this.http
      .get(API_URLothers + "subitems?" + "APIKEY=" + data + "&catId=" + catid)
      .pipe(map((res: Response) => res));
  }

  getBanners(data) {
    return this.http
      .get(API_URLothers + "banners?" + "APIKEY=" + data)
      .pipe(map((res: Response) => res));
  }
  ...
  getProductlist(data, catid, initialCount?, filterParam?) {
    ...
    if (filterParam) {
      allQueryParam += filterParam.Minimum
        ? "&minamount=" + filterParam.Minimum
        : "";
      allQueryParam += filterParam.Maximum
        ? "&maxamount=" + filterParam.Maximum
        : "";
      if (filterParam.Brand && filterParam.Brand.length !== 0) {
        let BrandId = "";
  ...
  getMyaddress(data) {
    return this.http
      .get(API_URLothers + "myaddress?" + "APIKEY=" + data)
      .pipe(map((res: Response) => res));
  }

  getBrandsList(data) {
    return this.http
      .get(API_URLothers + "brands?" + "APIKEY=" + data)
      .pipe(map((res: Response) => res));
  }

  getManufactureList(data) {
    return this.http
      .get(API_URLothers + "manufacturers?" + "APIKEY=" + data)
      .pipe(map((res: Response) => res));
  }
  ...
  getOrderchangeOrderStatusDetails(data, orderCode, status) {
    return this.http
      .get(
        `${API_URLothers}changeStatus?APIKEY=${data}&orderId=${orderCode}&status=${status}`
      )
      .pipe(map((res: Response) => res));
  }
  changeOrderStatus;
  ...
  getBrandDetails(data) {
    return this.http
      .get(API_URLothers + "getbrands?" + "APIKEY=" + data)
      .pipe(map((res: Response) => res));
  }
  ...
  getOrderList(data, count) {
    return this.http
      .get(API_URLothers + "myorders?" + "APIKEY=" + data + "&Limits=" + count)
      .pipe(map((res: Response) => res));
  }
  ...
  getProducts(url, apiKey) {
    return this.http
      .get(`${API_URLothers}products?APIKEY=${apiKey}${url}`)
      .pipe(map((res: Response) => res));
  }
}
