  ...
  callSubmitaddress() {
    if (
      ...
      if (this.otheropt == "") {
        ...
        this.http
          .post(this.API_URL + "addaddress", formData, { headers: headers })
          .subscribe(
            (data) => {
              console.log(data);
              ...
              this.loading.dismiss();
              if (
                data["response"].code == 1 &&
                this.isFromPage !== "MyDetailPage"
              ) {
                this.route.navigate([
                  "./shipping",
                  {
        ...
        .subscribe(
          (data) => {
            ...
            if (
              ...
              this.route.navigate([
                "./shipping",
                { finalprice: this.finalprice, couponCode: this.couponCode },
              ]);
            } else if (
              data["response"].code == 1 &&
              this.isFromPage === "MyDetailPage"
