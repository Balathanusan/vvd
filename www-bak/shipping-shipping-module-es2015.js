...
let ShippingPage = class ShippingPage {
    constructor(router, fun, http, loading, geolocation, route, authService) {
        this.router = router;
        this.fun = fun;
        this.http = http;
    ...
    callMyaddressapi() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.getApikey = localStorage.getItem('apikey');
            this.loading.present();
            yield this.authService.getMyaddress(this.getApikey).subscribe((res) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
