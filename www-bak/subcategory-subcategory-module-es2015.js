...
let SubcategoryPage = class SubcategoryPage {
    constructor(loading, route, router, db, authService) {
    ...
    gotoSubcategory(id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            yield this.authService.getsubCategory(this.getApikey, id).subscribe(res => {
    ...
    ionViewWillEnter() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.getdbvalues = yield this.db.getAllrecords(this.loggeduserid);
