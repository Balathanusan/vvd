...
let SearchPage = class SearchPage {
    ...
    constructor(authService, router, route, loading, db) {
        ...
        this.authService.productChanged.subscribe((value) => {
            ...
            console.log("app component changes observed....", value, this.items, this.changedProduct);
            this.items = [];
    ...
    ionViewWillEnter() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.calldata();
            this.loggeduserid = localStorage.getItem('loggeduserid');
            yield this.db.getAllrecords(this.loggeduserid).then(res => {
    ...
    loadProductList(catid, count, filterParam) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            console.log("list values", this.changedProduct);
            yield this.authService.getProductlist(this.getApikey, catid, count, filterParam).subscribe((res) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                this.getProductList = yield this.getProductListValues(res['response']['data']);
    ...
    getProductCountFromArray(productId, dataDB) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            var countQty = 0;
    ...
    calldata() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            let data;
            yield this.db.getAllrecords(userId).then(res => {
                data = res;
            });
            return data;
        });
    }
    getProductCountFromDB(productId, userId) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let countval = 0;
            yield this.db.getRecordByID(userId, productId).subscribe((res) => {
                if (res.length == 0) {
                    countval = 0;
                }
                else {
    ...
    getProductListValues(datas) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let products = [];
            var userId = localStorage.getItem('loggeduserid');
            let dataDB = yield this.calldata();
            for (let index in datas) {
                var productId = datas[index].id;
                let countQty = yield this.getProductCountFromArray(productId, dataDB);
    ...
    increment(index, id, currentItems, data) {
        ...
        this.val = countItem;
        this.db.getRecordByProductID(id).subscribe((res) => {
    ...
    callProductDetails(id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.loading.present();
            this.getApikey = localStorage.getItem('apikey');
            yield this.authService.getProductDetails(this.getApikey, id).subscribe((res) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                this.loading.dismiss();
